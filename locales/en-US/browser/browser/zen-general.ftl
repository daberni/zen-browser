...
tab-context-zen-add-essential-other-container-badge = Other container
tab-context-zen-add-essential-other-container-tooltip = This tab is in a different container than this space, so it can't be added to this space's Essentials.
